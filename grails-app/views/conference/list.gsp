			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="dates" title="${message(code: 'conference.dates.label', default: 'Dates')}" />
					
						<g:sortableColumn property="displayName" title="${message(code: 'conference.displayName.label', default: 'Display Name')}" />
				...
				<g:each in="${conferenceInstanceList}" status="i" var="conferenceInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: conferenceInstance, field: "startDate")}</td>
						...
						<td>${fieldValue(bean: conferenceInstance, field: "dates")}</td>
					
						<td>${fieldValue(bean: conferenceInstance, field: "displayName")}</td>
